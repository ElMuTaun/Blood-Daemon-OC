...
local function init()
  ...
  if not blood_orb_item then
    print("Blood Daemon can handle blood orb btw; put orb in equipment slot.")
  elseif not blood_orb_item.hasTag then
    print("Something, like NBT Tag is missing... are you sure this is \"bound\" \"blood orb\"?")
  end
  inv.equip()
...
local function doCraft()
  ...
  if DEBUG then
    print("ingredient_item: "..ingredient_item.name)
  end
  ...
  while true do
    ...
    if gatherFromBuffer() then
      repeat
        ...
        -- It could void items, a precious Amrok orb.
